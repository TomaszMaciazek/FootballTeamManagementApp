...
import { SurveyListItem } from 'src/app/models/listItems/survey-list-item.model';
import { SurveyTemplateQuery } from 'src/app/models/queries/survey-template-query.model';
import { TranslationProvider } from 'src/app/providers/translation-provider.model';
import { SurveyService } from 'src/app/services/survey.service';

@Component({
  selector: 'app-surveys-all',
  templateUrl: './surveys-all.component.html',
  styleUrls: ['./surveys-all.component.scss']
})
export class SurveysAllComponent implements OnInit {
