...
import { MyTestListItem } from 'src/app/models/listItems/my-test-list-item.model';
...
@Component({
  selector: 'app-tests-created-by-me',
  templateUrl: './tests-created-by-me.component.html',
  styleUrls: ['./tests-created-by-me.component.scss']
})
export class TestsCreatedByMeComponent implements OnInit {

  form: FormGroup;

  tests: MyTestListItem[];
  ...
  ngOnInit(): void {
    ...
    this.testService.getTestsCreatedByMe(query).then(res => {
