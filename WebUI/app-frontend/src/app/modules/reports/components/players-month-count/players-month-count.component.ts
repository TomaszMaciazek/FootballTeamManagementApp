...
@Component({
  selector: 'app-players-month-count',
  templateUrl: './players-month-count.component.html',
  styleUrls: ['./players-month-count.component.scss']
})
export class PlayersMonthCountComponent implements OnInit {
  ...
  getStatistics(startDate: string, endDate: string){
    this.spinner.show();
    this.reportService.getNewPlayersCount(startDate, endDate)
    .then(res => {
      this.statistics = res;
